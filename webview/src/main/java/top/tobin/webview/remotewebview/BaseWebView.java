package top.tobin.webview.remotewebview;
...
import top.tobin.webview.remotewebview.javascriptinterface.WebViewJavascriptInterface;
import top.tobin.webview.remotewebview.settings.WebviewDefaultSetting;
import top.tobin.webview.remotewebview.webviewclient.CustomWebViewClient;
import com.google.gson.Gson;

import java.util.HashMap;
import java.util.Map;

public class BaseWebView extends WebView implements CustomWebViewClient.WebviewTouch {
    ...
    public void registerWebViewCallBack(WebViewCallBack webViewCallBack) {
        ...
        mCustomWebViewClient = new CustomWebViewClient(this, webViewCallBack, mHeaders, this);
    ...
    protected void init(Context ctx) {
        ...
        if (remoteInterface == null) {
            ...
            remoteInterface.setJavascriptCommand((Context context, String cmd, String params) -> {
